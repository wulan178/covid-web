    ...
    return (
        <main className="lg:grid grid-cols-2 place-items-center gap-5 mt-16 lg:mt-9 p-5 md:px-6 px-4">
            <div className="col-span-1 lg:pl-5">
                <h1 className="md:w-11/12 mx-auto text-center lg:text-left lg:mx-0 text-2xl md:text-3xl lg:text-4xl font-bold">
                    Stay Informed, Stay Safe: Tracking COVID-19 Statistics in Indonesia
                </h1>
                <h4 className="md:mt-6 mt-5 text-center lg:text-left lg:mx-0 mx-auto sm:w-11/12 w-full">
            ...
            <div className="col-span-1 lg:block hidden">
                <Image src="/images/hero.svg" width={548} height={536} className="scale-90 pt-5" alt="hero" />
            </div>
        </main>
    );
}
